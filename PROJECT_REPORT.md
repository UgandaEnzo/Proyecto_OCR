...
- Se actualizó a `GROQ_MODEL="openai/gpt-oss-120b"` para texto y `VISION_MODEL="llama-3.2-11b-vision-preview"` para detección visual, ante la deprecación de `llama-3.3-70b-versatile` y `meta-llama/llama-4-scout-17b-16e-instruct` (agosto 2026).
