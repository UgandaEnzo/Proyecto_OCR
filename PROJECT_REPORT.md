...
- Se actualizó a `GROQ_MODEL="openai/gpt-oss-120b"` para texto y `VISION_MODEL="qwen/qwen3.6-27b"` para detección visual, ante la deprecación de `llama-3.3-70b-versatile`, `meta-llama/llama-4-scout-17b-16e-instruct` y `llama-3.2-11b-vision-preview`.
